...
const navigation = [
  { name: "Home", href: "/" },
  { name: "Space Newses", href: "SpaceNewsScreen" },
...
const HeaderNavBar = () => {
  ...
  return (
    <Disclosure as="nav" className="  bg-yellow-300 w-full">
      <div className="mx-auto px-2 sm:px-6 lg:px-8 w-full">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex shrink-0 items-center">
            <h1 className="text-white font-bold">Space News And Photos</h1>
          </div>
                  ...
                  <a
                    ...
                    className={classNames(
                      active === item.name
                        ...
                        : "text-white hover:bg-yellow-500 hover:text-black cursor-pointer",
